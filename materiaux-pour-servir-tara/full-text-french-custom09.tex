...
\usepackage[top=68mm, bottom=90mm, outer=81mm, inner=55mm]{geometry}
...
\patchcmd{\ps@plain}{\thepage}{\scriptsize\bfseries\color{Black}{\thepage}}{}{}
\makeatother
...
\sloppy
\bfseries
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{potalaka3.jpg}}
...
\renewcommand\thefootnote{{\scriptsize\bfseries\color{Black}{\arabic{footnote}}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{{\scriptsize\bfseries\color{Black}#1}}}
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\scshape\large Matériaux pour servir\\ à l'Histoire de \\la Déesse Bouddhique \\T\={a}r\={a}}
...
\begin{table}[H]
    ...
    \bfseries
    \tiny
    \begin{tabular}{|l|l|p{12mm}|p{30mm}|}
    \hline
...
\hspace*{25mm}[\d{n}u\d{n}\d{n}\={a}ndhak\={a}ra\d{m}
...
\hspace*{25mm}[n\={a}ya\d{m} bhaik\d{s}ya\d{m}\footnote{Ms. : yasy\={a}mn\={a}ya.}
